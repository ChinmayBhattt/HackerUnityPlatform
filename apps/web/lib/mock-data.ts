...
export const MOCK_EVENTS: ExtendedEvent[] = [
  {
    id: '6be0d68d-f187-4f5f-a424-ba221d2cb0d3',
    slug: 'hack-in-hills-26',
    title: "Hack in Hills '26",
    name: "Hack in Hills '26",
    tagline: 'Not a Marathon. A Mountain Sprint.',
    description: `<h2><b>HACK IN HILLS '26, MANALI</b></h2><br/><p><b>Not a Marathon. A Mountain Sprint.</b></p><br/><p>Hack in Hills '26 is a 24+ hour offline hackathon in Manali, bringing together developers, designers, marketers, and Web3 and gaming creators to build, collaborate, and solve problems with the Himalayas as the backdrop.</p><p>The team behind Hack in Hills has organized 300+ events, supported 15,000+ hackers, built communities of 50,000+ members, and worked with 50+ Web3 and gaming partners.</p><br/><p><b>What to Expect:</b></p><ul><li>40+ selected hackers</li><li>10,000+ registration target</li><li>35+ Web3 and Gaming partners</li><li>24+ hours of building</li><li>Mentors, speakers and judges</li><li>Networking with builders and ecosystem leaders</li><li>50,000 INR bounty pool</li><li>Offline finale in Manali</li></ul><br/><p>The hackathon follows a three round journey, starting with idea submission, moving to prototype development, and ending with the final offline hackathon in Manali.</p><br/><p><b>Round 1: Idea and PPT Submission</b></p><p>10 September to 30 September 2026 | Online</p><p>Submit a PPT or PDF covering:</p><ul><li>Problem statement</li><li>Proposed solution</li><li>Innovation and uniqueness</li><li>Target users and use case</li><li>Technology or tech stack</li><li>Expected impact</li><li>Implementation roadmap</li></ul><p>The best ideas will be shortlisted for the Prototype Round.</p><p>Shortlisting: 1 to 3 October 2026</p><br/><p><b>Round 2: Prototype Development</b></p><p>4 October to 31 October 2026 | Online</p><p>Shortlisted teams will build a functional prototype or MVP based on their submitted idea.</p><p>Teams may submit:</p><ul><li>Working prototype or MVP</li><li>Demo video</li><li>GitHub or repository</li><li>Documentation</li><li>Prototype or demo link</li></ul><p>Projects will be evaluated on innovation, technical execution, feasibility, usability and potential impact.</p><p>Finalists announced: 3 to 5 November 2026</p><br/><p><b>Round 3: Grand Finale</b></p><p>20 November 2026 | Manali, Himachal Pradesh | 24+ Hours | Offline</p><p>Finalists will come together in Manali for the final hackathon.</p><p>Teams will build, improve and present their projects with access to mentors, judges and ecosystem leaders.</p><p>Projects will be evaluated on: Innovation, Technical Execution, Impact, Scalability, Problem-Solution Fit, User Experience and Final Presentation.</p>`,
    category: EventCategory.HACKATHON,
    eventType: EventType.OFFLINE,
    mode: 'In-Person',
    domain: 'Web3, Gaming, AI',
    startDate: '2026-11-20T09:00:00Z',
    endDate: '2026-11-21T18:00:00Z',
    registrationDeadline: '2026-09-30T23:59:59Z',
    eligibilityRules: {
      teamSize: '1-4 Members',
      eligibility: 'Developers, designers, marketers, and Web3/gaming creators',
    },
    prizes: [
      { position: '🥇 Grand Winner', amount: 30000, description: '₹30,000 Cash Prize + Trophy + Venture & Ecosystem Access' },
      { position: '🥈 1st Runner Up', amount: 15000, description: '₹15,000 Cash Prize + Swag Kit + Fast-track Interviews' },
      { position: '🥉 2nd Runner Up', amount: 5000, description: '₹5,000 Cash Prize + Goodies & Certificates' },
    ],
    totalPrizeValue: 50000,
    prize: '₹50,000',
    prizeAmount: 50000,
    bannerUrl: '/gallery/hack-in-hills-26.webp',
    image: '/gallery/hack-in-hills-26.webp',
    rulesDocUrl: '#',
    registrationLink: '#',
    ...
    organizerId: '8069515d-5656-4709-86f9-1d15617d5cb7',
    ...
    tags: ['Web3', 'Gaming', 'AI', 'In-Person', 'Manali', 'MountainSprint'],
    bannerGradient: 'from-sky-900/60 via-emerald-950/80 to-black',
    tracks: [
      { title: 'Web3 & Decentralized Protocols', prize: '₹20,000 Pool', description: 'Smart contracts, DeFi, decentralized creator economy.' },
      { title: 'AI & Intelligent Agents', prize: '₹15,000 Pool', description: 'Autonomous agents, predictive systems, developer productivity.' },
      { title: 'Gaming & Mountain Tech Innovation', prize: '₹15,000 Pool', description: 'Interactive gaming, real-world utility, high-altitude IoT.' },
    ],
    stages: [
      { id: 'stg_hih_1', eventId: 'hack-in-hills-26', stageName: 'Round 1: Idea & PPT Submission (Online)', stageOrder: 1, startDate: '2026-09-10T00:00:00Z', endDate: '2026-09-30T23:59:59Z', description: 'Submit idea PPT or PDF covering Problem statement, Proposed solution, Tech stack, and Roadmap.' },
      { id: 'stg_hih_2', eventId: 'hack-in-hills-26', stageName: 'Round 2: Prototype Development (Online)', stageOrder: 2, startDate: '2026-10-04T00:00:00Z', endDate: '2026-10-31T23:59:59Z', description: 'Build and submit functional prototype or MVP with demo link and GitHub repository.' },
      { id: 'stg_hih_3', eventId: 'hack-in-hills-26', stageName: 'Round 3: Grand Finale (Manali, Offline)', stageOrder: 3, startDate: '2026-11-20T09:00:00Z', endDate: '2026-11-21T18:00:00Z', description: '24+ Hours non-stop offline hacking in Manali, Himachal Pradesh with industry mentors.' },
    ],
    faqs: [
      { id: 'faq_hih_1', eventId: 'hack-in-hills-26', question: "What is Hack in Hills '26?", answer: 'A 24+ hour offline hackathon in Manali, bringing together developers, designers, and Web3/gaming creators.', createdAt: '2026-09-10T00:00:00Z' },
      { id: 'faq_hih_2', eventId: 'hack-in-hills-26', question: 'Where is the offline finale held?', answer: 'The finale takes place in Manali, Himachal Pradesh.', createdAt: '2026-09-10T00:00:00Z' },
      { id: 'faq_hih_3', eventId: 'hack-in-hills-26', question: 'What is the team size?', answer: 'Teams can be from 1 to 4 members.', createdAt: '2026-09-10T00:00:00Z' },
    ],
    sponsors: [
  ...
  },
  {
    ...
    registrationCount: 1900,
    participantsDisplay: '1,900+',
    featured: true,
    ctaText: 'Learn More',
...

  {
    ...
    registrationCount: 5000,
    participantsDisplay: '5,000+',
    featured: true,
    ctaText: 'Learn More',
  ...
  },
  {
    ...
    registrationCount: 10000,
    participantsDisplay: '10,000+',
    featured: true,
    ctaText: 'Learn More',
    ...
    stages: [
      { id: 'stg_koc_1', eventId: 'kestra-orchestration', stageName: 'Challenge Completed', stageOrder: 1, startDate: '2026-05-01T00:00:00Z', endDate: '2026-06-30T23:59:59Z', description: 'Event completed with 10,000+ participating builders.' },
    ],
    faqs: [
  ...
  },
  {
    ...
    participantsCount: 11000,
    registrationCount: 11000,
    participantsDisplay: '11,000+',
    featured: true,
    ctaText: 'Learn More',
