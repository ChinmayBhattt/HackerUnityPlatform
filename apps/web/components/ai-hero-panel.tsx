...
export function AiHeroPanel() {
  ...
  return (
    <div className="relative w-full max-w-3xl mb-6 z-30">
      ...
      <div
        className={`relative w-full bg-white rounded-2xl sm:rounded-full border transition-all duration-200 shadow-xl shadow-slate-200/70 p-1.5 sm:p-2 flex flex-col sm:flex-row sm:items-center gap-2 ${
          activeTab === 'build'
            ? 'border-orange-300 ring-4 ring-orange-500/10'
            : 'border-slate-200 hover:border-slate-300 focus-within:border-[#0099e6] focus-within:ring-4 focus-within:ring-[#0099e6]/10'
        }`}
      >
