Mentor name: Tapendra Singh Ranawat
Project Lead @Metacube Software Pvt Ltd
...
• Full Stack .NET Development (ASP.NET Core, ASP.NET MVC, C#, SQL Server)
• AI-Driven Product Development & Intelligent Automation
• Enterprise Web Application Development
• Database Design & Performance Optimization
• Agile Delivery & Team Leadership
• Client Engagement & Product Strategy

Throughout my journey, I have designed and delivered enterprise solutions using technologies including ASP.NET Core, ASP.NET MVC, C#, CSLA, DevExpress, JavaScript, jQuery, REST APIs, SQL Server, and modern software engineering practices.
...
Beyond technology delivery, I am passionate about innovation, mentorship, and community contribution. I actively support the technology ecosystem as a Hackathon Jury Member, Guest Reviewer, and Mentor, contributing to innovation evaluation and technical guidance across national platforms and student communities.

Invited as Jury/Reviewer for events including:
